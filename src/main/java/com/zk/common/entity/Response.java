...
public class Response<T> implements Serializable {
    ...
    public Response(final Meta meta, final T data, final String id) {
        this.meta = meta;
        this.data = data;
        this.id = id;
    }
    ...
    public static <T> Response<T> successWithMsg(String message) {
        Meta meta = new Meta(true, message);
        return restResult(meta, null, null);
    }
    ...
    public static <T> Response<T> failureWithMsg(T data, String message, int code) {
        Meta meta = new Meta(false, message, code);
        return restResult(meta, data, (String) null);
    }
    ...
    public static <T> Response<T> failureWithDetailMsg(String message, Object detail) {
        Meta meta = new Meta(false, message, detail);
        return restResult(meta, null, null);
    }
    ...
    private static <T> Response<T> restResult(Meta meta, T data, String id) {
    ...
    public Response<T> setMeta(final Meta meta) {
        this.meta = meta;
        return this;
    }
    ...
    public static class Meta implements Serializable {
        ...
        public Meta setSuccess(final boolean success) {
            this.success = success;
            return this;
        }
        ...
        public Meta setMessage(final String message) {
            this.message = message;
            return this;
        }
        ...
        public Meta setCode(final int code) {
            this.code = code;
            return this;
        }
        ...
        public Meta setDetail(final Object detail) {
            this.detail = detail;
            return this;
        }
    }
